    ...
    <div className="drag-region flex shrink-0 items-center gap-0 overflow-x-auto border-b border-zinc-200 bg-zinc-100 dark:border-zinc-700 dark:bg-zinc-900">
      {tabs.map((tab) => {
        ...
        return (
          <div
            key={tab.id}
            className={`no-drag group relative flex shrink-0 cursor-pointer items-center gap-1.5 border-r border-zinc-200 dark:border-zinc-700 px-3 py-1.5 text-xs transition-colors ${
              isActive
